...
VALUES 
('Pasta Carbonara', 'Classic Italian pasta with bacon and eggs', 'Pork', 12.99,12.99, 15, '2024-04-15', 'Italian Bistro', 'Available', '2', '2024-03-12'),
('Vegetarian Salad', 'Fresh and healthy salad with mixed greens', 'Veggies', 12.99,8.99, 20, '2024-04-20', 'Vegetarian Delight', 'Available', '3', '2024-03-13'),
('Sushi Platter', 'Assorted sushi rolls with wasabi and soy sauce', 'Fish', 12.99,24.99, 12, '2024-04-25', 'Sushi Paradise', 'Available', '4', '2024-03-14'),
('Chocolate Cake', 'Rich and decadent chocolate cake with frosting', 'Dairy', 12.99,16.99, 8, '2024-04-10', 'Sweet Delights Bakery', 'Available', '5', '2024-03-15'),
('Steak Fajitas', 'Sizzling beef fajitas with bell peppers and onions', 'Beef', 12.99,21.99, 15, '2024-04-22', 'Tex-Mex Grill', 'Available', '6', '2024-03-23'),
('Greek Salad', 'Traditional Greek salad with olives and feta cheese', 'Veggies', 11.99,12.99, 20, '2024-04-25', 'Olympian Eats', 'Available', '7', '2024-03-24'),
('Dragon Roll', 'Specialty sushi roll with eel and avocado', 'Fish', 26.99,12.99, 10, '2024-04-20', 'Dragon Sushi Bar', 'Available', '8', '2024-03-25'),
('Tiramisu', 'Classic Italian dessert with coffee-soaked ladyfingers', 'Dairy', 12.99,19.99, 8, '2024-04-15', 'Dolce Vita Patisserie', 'Available', '9', '2024-03-26'),
('Chicken Alfredo Pizza', 'Creamy Alfredo sauce with chicken on a pizza crust', 'Poultry', 12.99,17.99, 15, '2024-04-18', 'Alfredos Pizza Palace', 'Available', '10', '2024-03-27'),
('Vegetarian Biryani', 'Spiced rice with mixed vegetables and aromatic spices', 'Veggies', 12.99,14.99, 20, '2024-04-28', 'Biryani Bliss', 'Available', '11', '2024-03-28'),
('Iced Matcha Latte', 'Cold matcha green tea latte with milk and ice', 'Veggies', 6.99,12.99, 30, '2024-04-30', 'Matcha Haven', 'Available', '12', '2024-03-29'),
('Caprese Panini', 'Grilled panini with mozzarella, tomatoes, and basil', 'Veggies', 9.99,12.99, 25, '2024-05-05', 'Panini Paradise', 'Available', '13', '2024-03-30'),
('Seafood Paella', 'Spanish rice dish with a variety of seafood', 'Fish', 23.99,12.99, 12, '2024-05-10', 'Paella Passion', 'Available', '14', '2024-04-01'),
('Mango Tango Smoothie', 'Sweet and tropical smoothie with fresh mango', 'Dairy', 8.99,12.99, 30, '2024-05-15', 'Smoothie Delight', 'Available', '15', '2024-04-02'),
('Spaghetti Bolognese', 'Classic Italian pasta with meat sauce', 'Beef', 14.99,12.99, 18, '2024-04-18', 'Mama Mia Trattoria', 'Available', '16', '2024-03-16'),
('Caesar Salad', 'Romaine lettuce with croutons and Caesar dressing', 'Veggies', 10.99,12.99, 25, '2024-04-22', 'Fresh Greens Cafe', 'Available', '17', '2024-03-17'),
('Sashimi Platter', 'Fresh slices of raw fish with wasabi and soy sauce', 'Fish', 29.99,12.99, 10, '2024-04-28', 'Tokyo Sushi House', 'Available', '18', '2024-03-18'),
('Cheesecake', 'Creamy and delightful cheesecake with fruit topping', 'Dairy', 18.99,12.99, 12, '2024-04-12', 'Sweet Indulgence Bakery', 'Available', '19', '2024-03-19'),
('Margarita Pizza', 'Classic pizza with tomato sauce and mozzarella', 'Veggies', 16.99,12.99, 15, '2024-04-14', 'Pizza Haven', 'Available', '20', '2024-03-20'),
('Vegetable Curry', 'Spicy and flavorful curry with mixed vegetables', 'Veggies', 13.99,12.99, 20, '2024-04-26', 'Spice Kingdom', 'Available', '21', '2024-03-21'),
('Fruit Smoothie', 'Refreshing smoothie with a mix of fresh fruits', 'Dairy', 7.99,12.99, 30, '2024-04-30', 'Smoothie Oasis', 'Available', '22', '2024-03-22');
